...
<section class="contact py-5">
	<div class="container py-lg-5 py-sm-3">
			<h2 class="heading text-capitalize text-center mb-sm-5 mb-4"> Insert Hospital</h2>
				<div class="col-xl-5 col-lg-6 col-md-8 col-sm-10 mx-auto text-center">
						<form action="insertlocation" method="post">
							...
							<div class="form-group contact-forms">
							  <input type="text" class="form-control" placeholder="Type of facility comma separated" name="facility"> 
							</div>
							<div class=" form-group contact-forms">
							  <input type="text" class="form-control" placeholder="Number of beds" name="beds" required>
							</div>
							<div class="form-group contact-forms">
							  <input type="text" class="form-control" placeholder="Operation Theaters Provided" name="operations" required>
							</div>
							<div class="form-group contact-forms">
							  <input type="text" class="form-control" placeholder="lattitude" name="lattitude" required> 
							</div>
							<div class="form-group contact-forms">
