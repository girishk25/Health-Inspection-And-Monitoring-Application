...
/**
 * Servlet implementation class LoginuserMobile
 */
@WebServlet("/LoginuserMobile")
public class LoginuserMobile extends HttpServlet {
	...
	public  ArrayList<Book> getAllCountries(String username, String password) {
	     //connection = con;
	    	...
	    	try {
	            ...
	            String updateOTP="update user set otp='"+val+"' where username='"+username+"'";
