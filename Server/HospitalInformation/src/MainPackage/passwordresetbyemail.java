...
/**
 * Servlet implementation class passwordresetbyemail
 */
@WebServlet("/passwordresetbyemail")
public class passwordresetbyemail extends HttpServlet {
	...
	public  ArrayList<Book> getAllCountries(String email,String phone) {
	     //connection = con;
	        ...
	        String query1="select * from user where emailid='"+email+"'";
	...
	private String getphonenum(String email) throws SQLException {
		String phonenum="";
		String qry="select * from user where emailid='"+email+"'";
