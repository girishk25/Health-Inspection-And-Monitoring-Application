...
/**
 * Servlet implementation class loadAppointmentdetails
 */
@WebServlet("/loadAppointmentdetails")
...
JsonObject jsonObject=new JsonObject();
	...
	public  ArrayList<Book> getAllCountries(String hospname) {
	     //connection = con;
	        ...
	        String sql="select * from multipleappointment where username='"+hospname+"'";
