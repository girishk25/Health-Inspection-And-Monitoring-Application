...
/**
 * Servlet implementation class loadPatientImagedetails
 */
@WebServlet("/loadPatientImagedetails")
public class loadPatientImagedetails extends HttpServlet {
     ...
     */
    public loadPatientImagedetails() {
        super();
...
JsonObject jsonObject=new JsonObject();
	...
	public  ArrayList<Book> getAllCountries(String hospname) {
	     //connection = con;
	        ...
	        String sql="select * from imagesofuser where username='"+hospname+"'";
