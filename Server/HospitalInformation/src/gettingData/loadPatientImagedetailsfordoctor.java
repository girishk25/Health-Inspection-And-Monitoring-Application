...
/**
 * Servlet implementation class loadPatientImagedetailsfordoctor
 */
@WebServlet("/loadPatientImagedetailsfordoctor")
public class loadPatientImagedetailsfordoctor extends HttpServlet {
     ...
     */
    public loadPatientImagedetailsfordoctor() {
        super();
...
JsonObject jsonObject=new JsonObject();
	...
	public  ArrayList<Book> getAllCountries(String hospname) {
	     //connection = con;
	        ...
	        String sql="select * from imagesofuser";
...
//	                book.setStock(rs.getString("operations"));
	            	book.setIdofimage(rs.getString("id"));
	            	book.setDateofimage(rs.getString("dateofdoc"));
	            	book.setImageup(rs.getString("imagename"));
	            	book.setUserimagename(rs.getString("username"));
