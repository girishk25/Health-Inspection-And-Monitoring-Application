...
/**
 * Servlet implementation class loadDoctorData
 */
@WebServlet("/loadDoctorData")
public class loadDoctorData extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		 ArrayList<Book> books=new ArrayList<Book>();
		 String hospname=request.getParameter("doctorname");
...
JsonObject jsonObject=new JsonObject();
	...
	public  ArrayList<Book> getAllCountries(String hospname) {
	     //connection = con;
	        ...
	        String sql="select * from doctorsdetails where doctorname='"+hospname+"'";
