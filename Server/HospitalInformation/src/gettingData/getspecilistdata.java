...
/**
 * Servlet implementation class getspecilistdata
 */
@WebServlet("/getspecilistdata")
public class getspecilistdata extends HttpServlet {
...
JsonObject jsonObject=new JsonObject();
	...
	public  ArrayList<Book> getAllCountries() {
	     //connection = con;
	        ...
	        String sql="select * from specialistdetails";
