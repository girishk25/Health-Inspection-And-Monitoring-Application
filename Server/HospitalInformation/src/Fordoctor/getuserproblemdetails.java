...
/**
 * Servlet implementation class getuserproblemdetails
 */
@WebServlet("/getuserproblemdetails")
public class getuserproblemdetails extends HttpServlet {
...
JsonObject jsonObject=new JsonObject();
	...
	public  ArrayList<Book> getAllCountries(String hospname) {
	     //connection = con;
	        ...
	        String sql="select * from user us,userconcern uc where us.username=uc.username";
...
//	            	book.setStatus(rs.getString("status"));
	            	...
	            	book.setPhonenumber(rs.getString("mobilenumber"));
	            	book.setUsername(rs.getString("username"));;;
	            	book.setSubject(rs.getString("subject"));
	            	book.setConcern(rs.getString("concern"));
