...
/**
 * Servlet implementation class validateOTPDoctor
 */
@WebServlet("/validateOTPDoctor")
public class validateOTPDoctor extends HttpServlet {
...
JsonObject jsonObject=new JsonObject();
	...
	public  ArrayList<Book> getAllCountries(String username, String password) {
	     //connection = con;
	        ...
	        String sql="select * from doctorsdetails where doctorname='"+username+"' and OTP='"+password+"'";
