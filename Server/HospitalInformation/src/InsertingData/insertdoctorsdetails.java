...
String emailid=request.getParameter("email");
		...
		String query1="insert into doctorsdetails(doctorname,hospitalname,availability,education,operation,about,phonenumber,specialization,password,emailid) values(?,?,?,?,?,?,?,?,?,?)";
