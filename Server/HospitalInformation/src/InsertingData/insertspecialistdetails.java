...
/**
 * Servlet implementation class insertspecialistdetails
 */
@WebServlet("/insertspecialistdetails")
public class insertspecialistdetails extends HttpServlet {
     ...
     */
    public insertspecialistdetails() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String query1="insert into specialistdetails(doctorname,hospitalname,availability,education,operation,about,phonenumber) values(?,?,?,?,?,?,?)";
