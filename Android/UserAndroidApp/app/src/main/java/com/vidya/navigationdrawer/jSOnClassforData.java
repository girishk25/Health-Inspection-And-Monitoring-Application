...
// try parse the string to a JSON object
    ...
    public static void forCallingStringBasic1() throws UnsupportedEncodingException {
        ...
        Request request = new Request.Builder()
                .url(UrlLinks.checkregistration)
                .post(body)
                .build();
    ...
    public static String forCallingServerString(String url, List<NameValuePair> nameValuePairs) throws JSONException { HttpClient httpclient = new DefaultHttpClient();
