            ...
            public void onClick(View view) {
                ...
                mDatePicker = new DatePickerDialog(TestingActivity.this, new DatePickerDialog.OnDateSetListener() {
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        String dateis="" + selectedday + "/" + selectedmonth + "/" + selectedyear;
                        Intent iop=new Intent(TestingActivity.this,AppointementActivity.class);
                        iop.putExtra("dateis",dateis);
                        iop.putExtra("doct",op);
                        // startActivity(iop);
                        startActivityForResult(iop, MY_REQUEST_CODE);
                        // finish();
                    }
                }, mYear, mMonth, mDay);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == MY_REQUEST_CODE) {
                if (data != null)
                    timetext.setText(data.getStringExtra("timeis"));
            }
        }
    }
}