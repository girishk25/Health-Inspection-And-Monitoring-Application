...
public class recyclerviewUserProblem extends RecyclerView.Adapter<recyclerviewUserProblem.MyViewHolder> {
    ...
    public recyclerviewUserProblem(Context mContext, List<Book> mData) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = mInflater.inflate(R.layout.card_main_userproblem,parent,false);
