...
public class ReviewTheAppFragment extends Fragment {
    ...
    private void loaddata() {
        ...
        String url = UrlLinks.getdoctorsdetails;
...
//                        json_data = jArray.getJSONObject(i);
          ...
          //  jArray = result.getJSONArray("bookName");
            ...
            for(int k=0;k<jArray.length();k++)
            {
                ...
                String wholedata="Doctor  Name "+doctorname+" \n specialization "+specialization+"\n availability "+availability+" \n education "+education+"\n operation "+operation+"\n about "+about+"\n about "+phonenumber;
                lstBook.add(new Book(doctorname,specialization,phonenumber,R.drawable.ic_launcher_background));
